...
/// Controller para `EvangelionTitle` que permite control programático
/// de la animación.
///
/// ## Ejemplo de uso
///
...
/// });
/// ```
class EvangelionTitleController extends FancyTitleController {
  /// Crea un controller para `EvangelionTitle`.
  EvangelionTitleController();
}
