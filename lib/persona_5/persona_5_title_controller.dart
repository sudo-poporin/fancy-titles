...
/// Controller para `Persona5Title` que permite control programático
/// de la animación.
///
/// ## Ejemplo de uso
///
...
/// });
/// ```
class Persona5TitleController extends FancyTitleController {
  /// Crea un controller para `Persona5Title`.
  Persona5TitleController();
}
